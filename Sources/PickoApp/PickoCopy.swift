...
public enum PickoCopy {
    ...
    public enum Review {
        ...
        public static let emptyTitle = "暂无待复核照片"
        public static let emptyMessage = "当前图库没有可继续整理的项目。你可以返回首页查看相似组或预删除篮。"
        public static let goSimilar = "去相似整理"
        public static let goBasket = "查看预删除篮"
        public static let goHome = "返回首页"
